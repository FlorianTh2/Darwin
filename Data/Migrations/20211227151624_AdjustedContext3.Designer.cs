...
namespace hello_asp_identity.Data.Migrations
{
    ...
    [Migration("20211227151624_AdjustedContext3")]
    partial class AdjustedContext3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hello_asp_identity.Domain.AppRole", b =>
                {
            ...
            modelBuilder.Entity("hello_asp_identity.Domain.AppUserRole", b =>
                {
                    b.HasOne("hello_asp_identity.Domain.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("hello_asp_identity.Domain.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("hello_asp_identity.Domain.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("hello_asp_identity.Domain.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
